...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    var o = {
        // Timeline related
        isIntro: true, isRollingLeft: false, currentTl: [], currentGravelTl: [], gravelProgress: [], prevGravelProgress: [], // SlowMotion
        slowMoFactor: 1, slowMoFactorBody: 1, // Head light status on/off
        lightsOnOff: [0, 0], // Wiggle head
        wiggleFrame: 0, allTheTime: 0, nowAndThen: 0, ranDur: 0, ranPos: 0, moveAmount: 0, // Null object to parallax head components
        headNull: {value: 0},
        ...
        init: function init() {
            ...
            this.animElems = ["bb8", "unit", "bodyShadow", "bodySurface", "rotatingHead", "headShadowBig", "headShadowSmall", "bouncingHead",
                              "antennaLong", "antennaShort", "headSurface", "upperLight", "lowerLight", "littleEye", "bigEye", "eyeHighlight",
                              "pupilGroup", "pupil1", "pupil2", "pupil3", "pupil4"
            ];
            this.bb8 = {};
            ...
            // Roll animation
            tl.to(this.bb8.bodySurface, 0.5, {rotation: spinDir, transformOrigin: "center", ease: Linear.easeNone, repeat: 1000}, 0).to(this.bb8.bb8,
                                                                                                                                        2, {
                                                                                                                                            x: 500,
                                                                                                                                            ease: Back.easeOut
                                                                                                                                        }, 0).to(
                this.bb8.bb8, 1, {y: 500, scale: 1.05, transformOrigin: "center bottom", ease: Power1.easeInOut}, 0).to(this.bb8.bodySurface, 1, {
                y: -400,
                ease: Power1.easeInOut
            }, 0).to(this.bb8.bodySurface, 2, {x: -600, ease: Power1.easeInOut}, 0).to(this.bb8.unit, 0.05, {y: 0, ease: Power1.easeInOut}, 0).to(
                this.bb8.bouncingHead, 0.05, {y: 0, ease: Power1.easeInOut}, 0).to(this.bb8.bodyShadow, 0.05,
                ...
                repeat: 500,
                yoyo: true
            }, 2).to(this.bb8.bb8, 0.5, {y: "-=100", scale: 1, transformOrigin: "center bottom", ease: Power1.easeInOut, repeat: 1000, yoyo: true},
                     1).to(this.bb8.bodySurface, 0.5, {y: "-=250", ease: Power1.easeInOut, repeat: 1000, yoyo: true}, 1).to(this.bb8.bodySurface, 5, {
                x: "+=200",
                ease: Power1.easeInOut,
                repeat: 500,
                yoyo: true
            }, 2).to(this.bb8.unit, 0.05, {y: "-=20", ease: Power1.easeInOut, repeat: 20000, yoyo: true}, 0.05).to(this.bb8.bodyShadow, 0.05, {
                scale: 1.03,
                transformOrigin: "center",
                ease: Power1.easeInOut,
                repeat: 20000,
                yoyo: true
            }, 0.05).to(this.bb8.bouncingHead, 0.05, {y: "-=30", ease: Power1.easeInOut, repeat: 20000, yoyo: true}, 0.08).to(this.bb8.rotatingHead,
                                                                                                                              10, {
                                                                                                                                  bezier: [{rotation: -20},
                                                                                                                                      {rotation: 10},
                                                                                                                                      {rotation: 0}
            ...
            tl.to(this.largeMask, 1.5, {scale: 0.95, ease: Back.easeInOut.config(1)}).add("bb8-in").to(this.bb8.bb8, 4.5, {
                x: 2000,
                y: 4300,
                scale: 3,
                ease: Elastic.easeOut.config(10)
            }, "bb8-in").to(this.bb8.bodySurface, 4.5, {rotation: -30, transformOrigin: "center", ease: Elastic.easeOut.config(10)}, "bb8-in").to(
                this.bb8.rotatingHead, 0.1, {rotation: -20, transformOrigin: "center"}, "bb8-in =+0.3").to(this.bb8.rotatingHead, 0.1,
                                                                                                           {rotation: 20, transformOrigin: "center"},
                                                                                                           "bb8-in =+1").to(this.bb8.rotatingHead, 3,
                                                                                                                            {
                                                                                                                                rotation: -15,
                                                                                                                                transformOrigin: "center",
                ...
                this.bb8.bouncingHead, 0.2, {y: "-=10", ease: Power3.easeInOut, repeat: 2, yoyo: true, repeatDelay: 0.4}, "bb8-in =+1").to(
                this.bb8.bouncingHead, 0.35, {y: "+=15", ease: Power1.easeInOut, repeat: 2, yoyo: true, repeatDelay: 0.2}, "bb8-in =+2.4").to(
                this.bb8.bouncingHead, 0.275, {y: "-=5", repeat: 1, yoyo: true, repeatDelay: 0.1, ease: Power4.easeInOut}, "bb8-in =+3.85").add(
                "bb8-distress").staggerTo([this.bb8.pupil1, this.bb8.pupil2, this.bb8.pupil3, this.bb8.pupil4], 0.2,
                                          {scale: 1.5, transformOrigin: "center", repeat: 3, yoyo: true}, 0.1, "bb8-in =+2.5").add("bb8-out").to(
                this.bb8.bb8, 1, {x: 4500, ease: Back.easeIn.config(2)}, "bb8-out").to(this.bb8.bodySurface, 1,
                                                                                       {rotation: 30, ease: Back.easeIn.config(2)}, "bb8-out").to(
                this.bb8.rotatingHead, 1.2, {rotation: -30, transformOrigin: "center", ease: Back.easeInOut.config(2)}, "bb8-out").set(this.bb8.bb8, {
                y: 600,
                scale: 1,
                transformOrigin: "center bottom"
            }).set(this.bb8.rotatingHead, {rotation: 0, transformOrigin: "center"}).add(o.animate);
            return tl;
